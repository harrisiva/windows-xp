...
function formatGeminiOutputForCmd(rawText) {
  ...
  window.XPDesktop.calculateResponsivePinballSize = calculateResponsivePinballSize;
  window.XPDesktop.formatGeminiOutputForCmd = formatGeminiOutputForCmd;
})();
